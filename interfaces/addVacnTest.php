                                ...
                                <div class="form-group col-lg-8 col-md-18 col-sm-8">
                                    ...
                                    <div  class="form-group col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div  class="form-group"  id="provinceIDDiv" style="margin-bottom: 0px;">
                                            ...
                                            <div style="margin-bottom: -10px;"   class="col-md-6 col-lg-6" >
                                                <select required class="form-control " name="subject" id="subject" onchange="showUser(this.value)">
                                                   <?php
                                    ...
                                    <div class="row">
                                        <div  class="form-group col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <!-- School Name-->
                                            <label for="School" class="control-label col-xs-6  required" style="text-align: left; padding-left: 30px;"> Grade :  </label>
                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="margin-top: 0px">
                                                <input type="text" class="form-control" id="grade" name="grade"  placeholder="Enter grade ex;6"/>
