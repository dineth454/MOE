                ...
                <div class="container-fluid">
                    <div class="col-lg-9 col-lg-offset-1" style="padding-top: 50px;">
                        ...
                        if (isset($_POST['submit'])) {
                            $schoolProvince = $_POST['provinceID'];
                            $schoolZonal = $_POST['zonalID'];
                            ...
                            if ($designationIdLoggedUser == 1) {
                                header("Location: PZInstituteUser_updateSchoolForm.php");
                                // echo 'yapa' ; 
                                //Principal kenekda kiyala balanawa
                            }elseif($designationIdLoggedUser == 2 && $provinceIdLoggedUser == $schoolProvince){
                                header("Location: PZInstituteUser_updateSchoolForm.php");

                            }elseif($designationIdLoggedUser == 3 && $zonalIdLoggedUser == $schoolZonal){
                                header("Location: PZInstituteUser_updateSchoolForm.php");
