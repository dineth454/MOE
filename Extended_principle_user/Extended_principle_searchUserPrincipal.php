                            ...
                            if($_POST["nic"] != '' || $_POST["fname"] != '' || $_POST["eId"] != '' ||
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td align='center'><a href='Extended_principle_searchResultPrincipal.php?rslt_ID=".$rslt_ID."'>more</a></td>";
                                        echo '</tr>';
                                    }
                                }else{
                                ...
                                echo '<script language="javascript">
                                        ...
                                        if (e) {
                                            window.location.href="Extended_principle_searchResultPrincipal.php";
                                        }
                                        });
                                    </script>';
                            }?>
