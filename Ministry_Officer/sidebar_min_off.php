<div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#collapse6"><i class="fa fa-exchange fa-2x" aria-hidden="true"></i> Reports <i></i></a>
                    </li>
                    
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#collapse7"><i class="fa fa-exchange fa-2x" aria-hidden="true"></i> View Map <i></i></a>
                    </li>
