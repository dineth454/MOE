                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <?php 
                                        if (isset($_POST['submit'])) {
                                            ...
                                            $res=$sub->selectsubject($name);
                                            if ($res > 0) {
                                                echo '<script language="javascript">';
                                                echo 'alert("This Subject name alreadt exists!!")';
                                                echo '</script>';
                                            }else{
                                                $sub->insertsubject($subcode,$name);
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                                <input maxlength="10" type="text" disabled class="form-control" id="subcode" name="subcode" placeholder="New Subject code" value="<?php echo $sub->getsubid(); ?>"/>
